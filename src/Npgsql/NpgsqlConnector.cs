...
#pragma warning restore CS8625
        ...
        internal ValueTask<IBackendMessage> ReadMessage(bool async,
            ...
            bool readingNotifications = false)
        {
            ...
            {
                return ReadMessageLong(dataRowLoadingMode, readingNotifications, cancellationToken: cancellationToken);
            }
            ...
            case BackendMessageCode.ErrorResponse:
                ...
                return ReadMessageLong(dataRowLoadingMode, readingNotifications2: false, cancellationToken: cancellationToken);
            }
                ...
                if (_pendingPrependedResponses > 0 && !isReadingPrependedMessage)
                {
                    try
                    {
                        ...
                        for (; _pendingPrependedResponses > 0; _pendingPrependedResponses--)
                            await ReadMessageLong(DataRowLoadingMode.Skip, false, true, cancellationToken);
                    }
        ...
        public bool Wait(int timeout)
        {
            ...
            using (StartUserAction(ConnectorState.Waiting))
            {
                ...
                while (true)
                {
                    ...
                    while (true)
                    {
                        var msg = ReadMessage(false, default).GetAwaiter().GetResult();
                        if (msg == null)
                        {
                    ...
                    while (true)
                    {
                        ...
                        try
                        {
                            ...
                            while (true)
                            {
                                ...
                                {
                                    receivedNotification = true;
                                    msg = await ReadMessage(true, cancellationToken);
                                }
