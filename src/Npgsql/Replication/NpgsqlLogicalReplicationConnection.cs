...
using Npgsql.Replication.Messages;
...
namespace Npgsql.Replication
{
    ...
    public sealed class NpgsqlLogicalReplicationConnection : NpgsqlReplicationConnection
    {
        ...
        /// </returns>
        public async Task<NpgsqlLogicalReplicationSlot> CreateReplicationSlot(
            string slotName,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var options = await this.CreateReplicationSlotForPlugin(slotName, "pgoutput", temporarySlot, slotSnapshotInitMode, cancellationToken);
            return new NpgsqlLogicalReplicationSlot(options);
        }
        ...
        public IAsyncEnumerable<LogicalReplicationProtocolMessage> StartReplication(
            NpgsqlLogicalReplicationSlot slot, NpgsqlLogicalReplicationOptions options, CancellationToken cancellationToken, NpgsqlLogSequenceNumber? walLocation = null)
        {
            using (NoSynchronizationContextScope.Enter())
                return StartReplicationInternal(slot, walLocation, options, cancellationToken);
        }

        async IAsyncEnumerable<LogicalReplicationProtocolMessage> StartReplicationInternal(
            NpgsqlLogicalReplicationSlot slot, NpgsqlLogSequenceNumber? walLocation,
            NpgsqlLogicalReplicationOptions options, [EnumeratorCancellation] CancellationToken cancellationToken)
        {
            var stream = StartReplicationInternal(commandBuilder =>
            {
