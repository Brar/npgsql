...
namespace Npgsql.Replication.Physical
{
    ...
    public class NpgsqlPhysicalReplicationSlot : NpgsqlReplicationSlot<NpgsqlPhysicalReplicationConnection, XLogData>
    {
        internal NpgsqlPhysicalReplicationSlot(NpgsqlPhysicalReplicationConnection connection, string slotName,
            LogSequenceNumber consistentPoint) : base(connection, slotName)
        {
        }
        ...
        public override Task<IAsyncEnumerable<XLogData>> StartReplication(LogSequenceNumber walLocation)
            => Connection.StartReplicationInternal(walLocation, SlotName, null);
        ...
        /// <see cref="XLogData"/> values.</returns>
        [PublicAPI]
        public Task<IAsyncEnumerable<XLogData>> StartReplication(string timeline, LogSequenceNumber walLocation)
            => Connection.StartReplicationInternal(walLocation, SlotName, timeline);
    }
}
