...
namespace Npgsql.Replication.PgOutput.Messages
{
    ...
    public sealed class InsertMessage : TransactionalMessage
    {
...
#endif
        {
            ...
            clone.Populate(WalStart, WalEnd, ServerClock, TransactionXid, RelationId, NewRow.Clone());
            return clone;
        }
        ...
        {
            var clone = new InsertMessage();
            clone.Populate(WalStart, WalEnd, ServerClock, TransactionXid, RelationId, await NewRow.CloneAsync(cancellationToken));
            return clone;
        }
    }
}
