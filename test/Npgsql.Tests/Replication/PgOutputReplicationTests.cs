...
namespace Npgsql.Tests.Replication
{
    ...
    // [TestFixture(ProtocolVersionMode.ProtocolV1, ReplicationDataMode.TextReplicationDataMode, TransactionStreamingMode.NonStreamingTransactionMode)]
    // [TestFixture(ProtocolVersionMode.ProtocolV2, ReplicationDataMode.DefaultReplicationDataMode, TransactionStreamingMode.DefaultTransactionMode)]
    // [TestFixture(ProtocolVersionMode.ProtocolV2, ReplicationDataMode.TextReplicationDataMode, TransactionStreamingMode.NonStreamingTransactionMode)]
    // [TestFixture(ProtocolVersionMode.ProtocolV2, ReplicationDataMode.BinaryReplicationDataMode, TransactionStreamingMode.DefaultTransactionMode)]
    // [TestFixture(ProtocolVersionMode.ProtocolV2, ReplicationDataMode.BinaryReplicationDataMode, TransactionStreamingMode.StreamingTransactionMode)]
        ...
        public Task Insert()
            => SafePgOutputReplicationTest(
                async (slotName, tableName, publicationName) =>
                {
                    ...
                    if (IsBinaryMode)
                        Assert.That(insertMsg.NewRow.GetInt32(0), Is.EqualTo(1));
                    else
                        Assert.That(insertMsg.NewRow.GetString(0), Is.EqualTo("1"));
                    Assert.That(insertMsg.NewRow.GetString(1), Is.EqualTo("val1"));
                    ...
                    Assert.That(insertMsg.NewRow.FieldCount, Is.EqualTo(2));
                    if (IsBinaryMode)
                        Assert.That(insertMsg.NewRow.GetInt32(0), Is.EqualTo(2));
                    else
                        Assert.That(insertMsg.NewRow.GetString(0), Is.EqualTo("2"));
                    Assert.That(insertMsg.NewRow.GetString(1), Is.EqualTo("val2"));
